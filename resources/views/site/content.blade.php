                        ...
                        <div class="inner_section">
                            <div class="row">
                                ...
                                <div class=" col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left">
                                    ...
                                    <div class="work_bottom"> <span>Want to know more..</span> <a href="{{ route('page', array('alias'=>$page->alias)) }}" class="contact_btn">{{ $page->name }}</a> </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 wow fadeInLeft delay-06s">
                    <div class="form">
                        ...
                        <div class="g-recaptcha" data-sitekey="6LeXSzgUAAAAAKHaTqJR2cAjYnnSJawBrUd3Dytc"></div>
